...
var ex4 = ("value here");
console.log('You can assign a value to a variable with the assignment operator, =. The following defines a variable as the string "value here"');
console.log("ex4");
...
/*4a: Characters put in between quotations marks are strings.
...
/*4b: When you need a literal-quote inside a string,
you need to use back-slashes like this: \"example\"*/
var ex4b = "text \"example\"."
console.log ('4b: When you need a literal-quote inside a string, you need to use back-slashes like this: \"example\"');
console.log (ex4b);

/*4ba: You can use a " and ' in the same line.
However, this becomes an issue when you are using the same character
within the same line. The following shows an example of this, with a good
and bad string (commented, but if you want to see what happens,
uncomment it!). Simply fix this with a backslash before the character. */
